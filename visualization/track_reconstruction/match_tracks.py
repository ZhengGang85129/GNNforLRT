...
def match_tracks(
    ...
    ghost_rate = (1 - purity_rec).mean()
    mean_track_length = tracks[matched_reco_track].nhits.mean() 
    #print(tracks[matched_reco_track].nhits.mean())
    #print(ghost_rate.mean())
    return (
        n_true_tracks,
        n_reco_tracks,
